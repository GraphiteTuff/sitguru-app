...
const helpCategories: HelpCategory[] = [
  ...
  { emoji: '🧭', title: 'Real Wiring Start Plan', description: 'Review the visual-only safest implementation order before real auth, roles, profiles, bookings, messages, payments, notifications, and admin wiring begins.', actionLabel: 'Open Real Wiring Start Plan', href: '/wiring-start-plan' },
  ...
  return (
    <SitGuruScreen scroll center={false} maxWidth={760}>
      <View style={styles.page}>
        ...
        <View style={styles.card}><Text style={styles.sectionTitle}>Contact options</Text><View style={styles.buttonRow}><Button label="Message support" href="/conversation" primary /><Button label="Notifications" href="/notifications" /><Button label="Account settings" href="/account" /><Button label="Admin Operations Preview" href="/admin-operations" /><Button label="Backend Readiness" href="/backend-readiness" /><Button label="Real Wiring Start Plan" href="/wiring-start-plan" /><Button label="Supabase Schema Readiness" href="/schema-readiness" /><Button label="Release Readiness" href="/release-readiness" /><Button label="QA Test Center" href="/qa-test-center" /></View></View>
