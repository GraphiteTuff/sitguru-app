...
const existingRoutes = new Set(['/wiring-start-plan', '/schema-readiness', '/auth-readiness', '/account', '/release-readiness', '/admin-operations', '/payments', '/booking-details', '/pawreport-live', '/guru-pricing', '/support', '/find-care', '/guru-profile', '/pet-passports', '/conversation', '/request-booking', '/guru-live-walk', '/notifications', '/reviews', '/qa-test-center']);
...
const phases: Phase[] = [
  { title: 'Phase 1: Auth and user roles', status: 'Blocker', tasks: ['Choose sign-in policy', 'Define Pet Parent, Guru, Ambassador, and Admin roles', 'Plan account recovery'], routes: ['/account', '/role-selection', '/auth-readiness'], action: { label: 'Auth & Role Session Plan', href: route('/auth-readiness') } },
