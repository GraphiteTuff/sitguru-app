    ...
    <SitGuruScreen scroll center={false} maxWidth={760}>
      <View style={styles.page}>
        <View style={styles.hero}>
          ...
          <Text style={styles.visualNote}>No real GPS, camera upload, push notification, or backend update is connected.</Text>
        </View>
        ...
        <View style={styles.safetyCard}><Text style={styles.sectionTitle}>Safety reminder</Text><Text style={styles.body}>GPS is visual-only here. Only track location during active booked care once native GPS is wired.</Text><Text style={styles.body}>End walk when care is complete.</Text></View>
