...
export default function AmbassadorDashboardScreen() {
  ...
  function openPortal(view?: 'today' | 'calendar' | 'activities' | 'marketing' | 'leads') {
    router.push(
      {
                ...
                >
                  ...
                  <View style={styles.workspaceHero}>
                    <Text style={styles.workspaceEyebrow}>
                      SITGURU AMBASSADOR WORKSPACE
                    </Text>

                    <Text style={styles.workspaceTitle}>
                      Your Ambassador tools, progress, and earnings
                    </Text>
                    ...
                    <View style={styles.codeCard}>
                      <View style={styles.codeCopy}>
                        <Text style={styles.codeLabel}>AMBASSADOR CODE</Text>
                        <Text style={styles.codeValue}>
                          {referralCode || 'Not assigned'}
                        </Text>
                      </View>
                      <Text style={styles.codeDetail}>
                        Use this code on referrals, QR flyers, social posts,
                        vendor tables, and local outreach.
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.sectionBlock}>
                    <View style={styles.sectionHeaderRow}>
                      <View>
                        ...
                        <Text style={styles.sectionTitle}>Open your Ambassador tools</Text>
                      </View>
                    </View>
                    ...
                    <View style={styles.toolGrid}>
                      ...
                      <ToolkitAction
                        ...
                        label="Social"
                        onPress={() =>
                          router.push('/ambassador-social' as never)
                        }
                        styles={styles}
                      />
                      <ToolkitAction
                    ...
                    <View style={styles.impactCard}>
                      ...
                      <View style={styles.impactFooter}>
                        <Text style={styles.impactFooterText}>
                          {formatNumber(data.clicks)} tracked visits
                        </Text>
                        <Text style={styles.impactFooterText}>
                          {formatNumber(data.signups)} verified referrals
                        </Text>
                        <Text style={styles.impactFooterText}>
                      ...
                      >
                        ...
                        <View style={styles.analyticsButtonCopy}>
                          ...
                          <Text style={styles.analyticsButtonText}>
                            Visits, conversions, channels, bookings, and rewards
                          </Text>
                        </View>
                  ...
                  <View style={styles.readinessCard}>
                    ...
                    <ReadinessRow
                      detail={
                        data.onboardingStatus === 'complete'
                          ? 'Your Ambassador onboarding packet is complete.'
                          : data.onboardingStatus === 'pending'
                            ? 'Your packet is submitted and waiting for review.'
                            : 'Review the Ambassador terms, conduct, referral, and payout expectations.'
                      }
                    ...
                    <ReadinessRow
                      detail={
                        data.trainingRequired > 0
                          ? `${data.trainingCompleted} of ${data.trainingRequired} required steps complete`
                          : 'Required training will appear when assigned.'
                      }
                    ...
                    <ReadinessRow
                      detail={`${data.payoutCompleted} of ${data.payoutTotal} payout requirements complete`}
                  ...
                  >
                    ...
                    <View style={styles.analyticsStripCopy}>
                      ...
                      <Text style={styles.analyticsStripText}>
                        Review performance and attribution
                      </Text>
                    </View>
                    <ChevronRight
                      color={palette.accent}
