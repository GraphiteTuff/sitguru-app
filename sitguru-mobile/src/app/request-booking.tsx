...
const requestSteps: RequestStepConfig[] = [
  ...
  },
  {
    ...
    description:
      'Review the Guru, pet, service, schedule, notes, and estimated price before sending.',
  },
  {
    step: 6,
    shortTitle: 'Send',
...
function getEstimate({
  ...
  const additionalPetTotal = additionalPets > 0 ? additionalPets * 10 * units : 0;
  const estimatedSubtotal = baseTotal + additionalPetTotal;
      ...
      <View style={styles.priceCard}>
        ...
        <View style={styles.priceRows}>
          ...
          {estimate.additionalPetTotal > 0 ? (
            <View style={styles.priceRow}>
              <Text style={styles.priceLabel}>Additional pet estimate</Text>
              <Text style={styles.priceValue}>
        ...
        <Text style={styles.priceDisclaimer}>
          This is an estimate. Gurus can update availability, service rates, and
          final pricing before accepting.
        </Text>
      </View>
    );
  }
      ...
      return (
        <View style={styles.stepBody}>
          ...
          <View style={styles.infoCard}>
            <Text style={styles.infoCardTitle}>Pet Passports save time</Text>
            <Text style={styles.infoCardText}>
              Gurus can review pet details, routines, notes, and care needs
      ...
      <View style={styles.stepBody}>
        <View style={styles.successPanel}>
          ...
          <Text style={styles.successText}>
            Your request includes the pet, service, dates, timing, notes, and
            estimated price. Payment should happen later after the Guru accepts.
          </Text>
        ...
        <View style={[styles.heroPanel, isWide && styles.heroPanelWide]}>
          <View style={styles.heroCopy}>
            ...
            <Text style={styles.subtitle}>
              Choose your pet, service, calendar dates, timing, and notes. Prices
              are estimated until the Guru accepts.
            </Text>
          ...
          <View style={styles.heroPhotoCard}>
            ...
            <View style={styles.heroFloatingCard}>
              ...
              <Text style={styles.heroFloatingText}>
                Gurus can update rates by service, day, and availability.
              </Text>
            </View>
          </View>
        </View>
