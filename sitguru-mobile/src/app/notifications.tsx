...
const filters = ['All', 'Bookings', 'Messages', 'PawReport', 'Payments', 'Guru', 'Ambassador', 'Support'];

const notifications: NotificationItem[] = [
  { id: 'guru-request', icon: '🧘', category: 'Guru', title: 'New booking request', message: 'Luna has a drop-in request ready for Guru review.', time: '12 min ago', unread: true, actionLabel: 'View requests', href: '/guru-requests' },
  { id: 'pet-parent-message', icon: '💬', category: 'Messages', title: 'Pet Parent message', message: 'A Pet Parent is waiting for your reply about care details.', time: '18 min ago', unread: true, actionLabel: 'Open messages', href: '/conversation' },
  { id: 'upcoming-visit', icon: '📋', category: 'Bookings', title: 'Upcoming visit', message: 'Scout’s walk is coming up. Review booking notes before care starts.', time: 'Today', unread: true, actionLabel: 'View booking', href: '/booking-details' },
  { id: 'pawreport-reminder', icon: '🐾', category: 'PawReport', title: 'PawReport reminder', message: 'Start PawReport Live when care begins and keep the Pet Parent updated.', time: 'Today', unread: true, actionLabel: 'Start walk', href: '/guru-live-walk' },
  { id: 'payout-update', icon: '💸', category: 'Payments', title: 'Payout update', message: 'Review payout readiness and rewards/payment status.', time: 'Yesterday', unread: false, actionLabel: 'Open payments', href: '/payments' },
  { id: 'review-received', icon: '⭐', category: 'Guru', title: 'Review received', message: 'A completed visit review is ready to view.', time: '2 days ago', unread: false, actionLabel: 'View reviews', href: '/reviews' },
  { id: 'referral-signup', icon: '🌟', category: 'Ambassador', title: 'New referral signup', message: 'A referral started signup from your Ambassador link preview.', time: 'Today', unread: true, actionLabel: 'Open Ambassador hub', href: '/ambassador-dashboard' },
  { id: 'lead-follow-up', icon: '📌', category: 'Ambassador', title: 'Lead follow-up reminder', message: 'Follow up with a local prospect while the conversation is warm.', time: 'Today', unread: true, actionLabel: 'Open hub', href: '/ambassador-dashboard' },
  { id: 'reward-update', icon: '🎁', category: 'Ambassador', title: 'Reward update', message: 'Referral rewards tracker has a preview status update.', time: 'Yesterday', unread: false, actionLabel: 'View rewards', href: '/payments' },
  { id: 'training-reminder', icon: '🎓', category: 'Ambassador', title: 'Training reminder', message: 'Complete Ambassador basics before your next outreach push.', time: 'This week', unread: false, actionLabel: 'Open training', href: '/ambassador-dashboard' },
  { id: 'outreach-idea', icon: '📣', category: 'Ambassador', title: 'Outreach idea', message: 'Share SitGuru with a local pet group, vet office, or neighborhood event.', time: 'This week', unread: false, actionLabel: 'Open toolkit', href: '/ambassador-dashboard' },
  { id: 'support-response', icon: '🛟', category: 'Support', title: 'Support response', message: 'SitGuru support has a care or growth update ready for review.', time: 'Now', unread: true, actionLabel: 'Open support', href: '/support' },
];
