    ...
    <SitGuruScreen scroll center={false} maxWidth={760}>
      <View style={styles.page}>
        <View style={styles.hero}>
          ...
          <Text style={styles.visualNote}>Visual-only tracking preview. No real GPS, push notification, photo, or backend updates are connected.</Text>
        </View>
        ...
        <View style={styles.safetyCard}>
          ...
          <Text style={styles.body}>Only Pet Parent, assigned Guru, and SitGuru support should view active visit tracking once wired; GPS is not active in this preview.</Text>
        </View>

        <View style={styles.actions}>
          <Button label="Notifications" onPress={() => router.push('/notifications')} />
          <Button label="Help & Support" onPress={() => router.push('/support')} />
