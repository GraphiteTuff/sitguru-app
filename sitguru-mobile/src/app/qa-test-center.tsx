...
const routeRows: RouteRow[] = [
  ['/', 'Welcome and public entry', 'Opens'], ['/find-care', 'Pet Parent care discovery', 'Needs test'], ['/guru-profile', 'Guru public profile preview', 'Needs test'], ['/pet-passports', 'Pet care notes hub', 'Needs test'], ['/request-booking', 'Pet Parent Booking Request', 'Needs test'], ['/booking-details', 'Booking Details hub', 'Needs test'], ['/pawreport-live', 'Pet Parent live tracking view', 'Visual-only'], ['/guru-live-walk', 'Guru live walk controls', 'Visual-only'], ['/conversation', 'Messaging preview', 'Needs test'], ['/notifications', 'Notifications', 'Needs test'], ['/account', 'Account & Settings', 'Opens'], ['/support', 'Help & Support', 'Needs test'], ['/payments', 'Payments & Payouts', 'Visual-only'], ['/reviews', 'Review flow', 'Optional'], ['/guru-pricing', 'Guru Pricing Workspace', 'Visual-only'], ['/guru-requests', 'Guru request queue', 'Optional'], ['/admin-operations', 'Admin Operations', 'Visual-only'], ['/release-readiness', 'Release Readiness', 'Needs test'], ['/backend-readiness', 'Backend Readiness', 'Needs test'], ['/qa-test-center', 'QA Test Center', 'Opens'],
