...
export const CARE_SERVICES: CareServiceOption[] = [
  {
    key: 'dog_walking',
    label: 'Dog Walking',
    helper: 'Neighborhood walks',
    serviceType: 'Dog Walking',
  },
  {
    key: 'pet_sitting',
    label: 'Pet Sitting',
    helper: 'Care in your home',
    serviceType: 'Pet Sitting',
  },
  {
    key: 'boarding',
    label: 'Boarding',
    helper: 'Overnight with a Guru',
    serviceType: 'Boarding',
  },
  {
    key: 'day_care',
    label: 'Doggy Day Care',
    helper: 'Play during the day',
    serviceType: 'Doggy Day Care',
  },
  {
    key: 'drop_in',
    label: 'Drop-In Visits',
    helper: 'Food, potty, and a hello',
    serviceType: 'Drop-In Visits',
  },
  {
    key: 'house_sitting',
    label: 'House Sitting',
    helper: 'Overnight in your home',
    serviceType: 'House Sitting',
  },
  {
    key: 'training_support',
    label: 'Training Support',
    helper: 'Coaching with care',
    serviceType: 'Training Support',
  },
  {
    key: 'medication_help',
    label: 'Medication Help',
    helper: 'Meds and special care',
    serviceType: 'Medication Help',
  },
  {
    key: 'custom_care',
    label: 'Custom Care',
    helper: 'Made for your pet',
