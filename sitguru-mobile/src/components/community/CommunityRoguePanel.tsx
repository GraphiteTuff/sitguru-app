...
type CommunityRoguePanelProps = {
  eventSlug?: string;
  eventTitle?: string;
};

export default function CommunityRoguePanel({
  eventSlug,
  eventTitle,
}: CommunityRoguePanelProps) {
  ...
  function handleChip(question: string) {
    ...
    void trackMobileEvent({
      ...
      pagePath: eventSlug ? `/community/events/${eventSlug}` : "/community/events",
      metadata: {
        question,
        eventSlug,
        eventTitle,
  ...
  return (
    <View style={styles.panel}>
      <View style={styles.headerRow}>
        ...
        <Text style={styles.title}>Ask Rogue about this event</Text>
      </View>
      <Text style={styles.subtitle}>
        Quick answers about RSVP, pet-friendly details, and joining SitGuru.
      </Text>
      ...
      <Pressable
        ...
        onPress={() => {
          void trackMobileEvent({
            eventName: "community_rogue_open",
            source: "mobile_community_event",
            metadata: { eventSlug, eventTitle },
          });
          router.push({ pathname: "/ai-companion", params: { id: "rogue" } });
        }}
      >
        <Text style={styles.chatButtonText}>Chat with Rogue</Text>
      </Pressable>
    </View>
  );
}
