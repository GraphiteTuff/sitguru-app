...
export type ProfileSummary = { id: string; email: string | null; full_name: string | null; first_name: string | null; last_name: string | null; role: string | null; avatar_url: string | null; city: string | null; state: string | null; state_code: string | null };
