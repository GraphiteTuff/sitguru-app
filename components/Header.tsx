...
import type { DashboardSwitchRole } from "@/lib/dashboard/role-switch";
...
export default function Header({ user = null }: HeaderProps) {
  ...
  const switcherAccess = {
    parent: hasCustomerAccess,
    guru: hasGuruAccess,
    ambassador: hasAmbassadorAccess,
    admin: hasAdminAccess,
  };
  const switcherCurrentRole: DashboardSwitchRole | null =
    headerMode === "customer"
      ? "parent"
      : headerMode === "guru"
        ? "guru"
        : headerMode === "ambassador"
          ? "ambassador"
          : headerMode === "admin"
            ? "admin"
            : null;
            ...
            <>
              {roleSwitchLinks.length ? (
                <GlobalDashboardSwitcher
                  currentRole={switcherCurrentRole}
                  access={switcherAccess}
                  variant="nav"
