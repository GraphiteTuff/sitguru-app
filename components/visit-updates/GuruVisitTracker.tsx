...
export default function GuruVisitTracker({
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      <div className="bg-gradient-to-br from-sky-50 via-white to-emerald-50 p-5 sm:p-6 border-b border-slate-200">
          ...
          <>
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              >
                ...
                <span className="mt-2 block font-bold text-slate-950">Pee</span>
              </button>
              ...
              >
                <span className="block text-2xl">🐾</span>
                <span className="mt-2 block font-bold text-slate-950">Poop</span>
              </button>
              ...
              >
                ...
                <span className="mt-2 block font-bold text-slate-950">Food</span>
              </button>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <textarea
                ...
                className="mt-2 w-full rounded-2xl border border-slate-200 bg-white p-3 text-sm outline-none focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
              />
              <button
                type="button"
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <input
                ...
                type="file"
                accept="image/*"
                className="mt-3 block w-full rounded-2xl border border-slate-200 bg-white p-3 text-sm"
                onChange={(event) => {
              ...
              <div className="mt-4">
                ...
                <button
                  ...
                  disabled={isPending}
                  className="mt-3 w-full rounded-2xl bg-white px-5 py-3 font-bold text-slate-900 border border-slate-200 transition hover:bg-slate-100 disabled:opacity-60"
                >
                  Add Photo URL
                </button>
              </div>
            ...
            <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
              ...
              <textarea
                ...
                className="mt-2 w-full rounded-2xl border border-emerald-200 bg-white p-3 text-sm outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
              />
              <button
                type="button"
