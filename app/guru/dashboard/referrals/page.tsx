      ...
      <div className="mx-auto max-w-7xl space-y-8">
        <section className="rounded-[32px] border border-white/10 bg-white/5 p-6 shadow-[0_10px_40px_rgba(0,0,0,0.22)] backdrop-blur-sm lg:p-8">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
            Track referral traffic, code usage, commissions, and partner growth from one place.
          </p>
        </section>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 shadow-[0_10px_40px_rgba(0,0,0,0.18)] backdrop-blur-sm">
            ...
            <p className="mt-2 text-sm text-slate-300">
              Referral traffic metrics will appear here.
            </p>
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 shadow-[0_10px_40px_rgba(0,0,0,0.18)] backdrop-blur-sm">
            ...
            <p className="mt-3 text-3xl font-black text-white">0</p>
            <p className="mt-2 text-sm text-slate-300">
              Referred signup counts will appear here.
            </p>
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 shadow-[0_10px_40px_rgba(0,0,0,0.18)] backdrop-blur-sm">
            ...
            <p className="mt-3 text-3xl font-black text-white">0</p>
            <p className="mt-2 text-sm text-slate-300">
              Completed referral bookings will appear here.
            </p>
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-5 shadow-[0_10px_40px_rgba(0,0,0,0.18)] backdrop-blur-sm">
            ...
            <p className="mt-3 text-3xl font-black text-white">$0</p>
            <p className="mt-2 text-sm text-slate-300">
              Referral commission earnings will appear here.
            </p>
          </div>
        </div>
        ...
        <section className="rounded-[32px] border border-white/10 bg-white/5 p-6 shadow-[0_10px_40px_rgba(0,0,0,0.22)] backdrop-blur-sm lg:p-8">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
            ...
            Once the build is clean, you can add referral code creation, partner tracking, and payout reporting here.
          </p>
        </section>
      </div>
    </div>
