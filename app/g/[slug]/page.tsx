...
export default async function GuruReferralPage({
  ...
  const guruApplyHref = `/guru/apply?ref=${encodeURIComponent(referral.code)}`;
  const guruInfoHref = `/gurus?ref=${encodeURIComponent(referral.code)}`;
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 sm:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-10 lg:py-16">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-3xl text-5xl font-black leading-[0.95] tracking-tight text-green-950 sm:text-6xl lg:text-7xl">
              {displayName} invited you to become a SitGuru
            </h1>

            <p className="mt-6 max-w-2xl text-xl font-semibold leading-8 text-slate-800">
              Apply to become a trusted Guru and help pet parents find reliable,
              caring support in their community.
            </p>
            ...
            <div className="mt-8 rounded-2xl border border-green-100 bg-green-50 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-700">
                This referral code will be passed into the Guru application flow.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-[2rem] border border-green-100 bg-gradient-to-br from-green-50 via-white to-amber-50 p-4 shadow-2xl shadow-green-950/10">
            <div className="rounded-[1.5rem] bg-white p-5 shadow-sm">
              <div className="rounded-[1.25rem] bg-[radial-gradient(circle_at_35%_25%,#bbf7d0,transparent_28%),radial-gradient(circle_at_80%_20%,#fed7aa,transparent_30%),linear-gradient(135deg,#f0fdf4,#fff7ed)] p-6">
                <div className="max-w-md rounded-2xl bg-white/90 p-5 shadow-sm">
                  ...
                  <h2 className="mt-3 text-3xl font-black text-green-950">
                    Help pets and earn as a trusted caregiver.
                  </h2>
                  <p className="mt-3 text-sm leading-6 text-slate-700">
                    Gurus can support pet sitting, dog walking, check-ins, and
                    care services through SitGuru.
                  </p>
                </div>
              ...
              <div className="mt-4 rounded-2xl border border-green-100 bg-[#fbfaf6] p-5">
                <p className="text-sm font-black text-green-950">
                  Trusted Gurus help SitGuru grow with care.
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Guru referral links help SitGuru reward verified recruitment.
                </p>
              </div>
            </div>
          </div>
          ...
          {[
            {
              title: "Apply online",
              description:
                "Start your Guru application and tell SitGuru about your pet-care experience.",
              icon: "📝",
            },
            {
              title: "Complete approval",
              description:
                "Move through SitGuru onboarding, profile setup, and trust/safety steps.",
              icon: "🛡️",
            },
            {
              title: "Start helping pets",
              description:
                "Once approved, receive booking opportunities and support pet parents nearby.",
              icon: "🐾",
            },
          ].map((item) => (
            <div
          ...
          <div className="grid gap-8 p-8 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-lg leading-8 text-green-100">
                ...
                your application back to this referral.
              </p>
            </div>
