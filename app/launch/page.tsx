    ...
    <main className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#f7fff9_0%,#f2fbf5_40%,#ffffff_100%)] text-slate-900">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <header className="flex items-center justify-center py-4 sm:justify-start">
          <div className="inline-flex items-center gap-3 rounded-full border border-emerald-100 bg-white/85 px-4 py-2 shadow-sm backdrop-blur">
            <div className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-full bg-white ring-1 ring-emerald-100">
              <img
                src="/sitguru-logo-cropped.png.png"
                alt="SitGuru logo"
        ...
        <section className="grid items-center gap-10 pb-10 pt-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12 lg:pt-10">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-sm leading-7 text-slate-500 sm:text-base">
              Fresh, trusted pet care for <span className="font-semibold text-slate-700">Pet Parents</span> and{" "}
        ...
        <section className="grid gap-4 pb-12 md:grid-cols-3">
          <BenefitCard
            title="Trusted Care"
            body="A better way to connect with reliable pet care you can feel good about."
          />
          <BenefitCard
            title="Simple Booking"
            body="A cleaner, easier experience designed to make finding care feel effortless."
          />
          <BenefitCard
            title="Be First"
            body="Join early and get first notice when SitGuru officially launches."
          />
        </section>
        ...
        <footer className="border-t border-emerald-100 py-6">
          ...
          <p className="mt-4 text-xs leading-6 text-slate-500">
            *A <span className="font-semibold text-slate-700">Guru</span> is a trusted pet care provider on the
            SitGuru network offering services like pet sitting, dog walking,
            boarding, daycare, drop-ins, and more.
          </p>
        </footer>
      </div>
    </main>
