...
const adminLinks = [
  { href: "/admin/analytics", label: "Analytics Hub" },
          ...
          <div className="flex flex-col gap-8 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-4xl">
              ...
              <p className="mt-4 max-w-3xl text-sm font-semibold leading-7 text-slate-600 sm:text-base">
                This dashboard combines booking, message, referral, ambassador, growth-campaign, launch, and tracked event data so you can see whether SitGuru is growing through Pet Parents, Gurus, Ambassadors, ZipRecruiter, Indeed, PA CareerLink, and referral programs.
              </p>
