...
const adminRoutes = {
  ...
  ambassadorTraining: "/admin/ambassador-training/manage",
...
function revalidateUniversityPaths() {
  ...
  revalidatePath(adminRoutes.universityHub);
  revalidatePath("/ambassador/training");
  revalidatePath("/ambassador/dashboard");
  revalidatePath("/guru/dashboard/university");
...
export default async function AdminUniversityCurriculumManagePage({
  searchParams,
}: PageProps) {
  await requireTrainingAdmin();
        ...
        <section className="rounded-[30px] border border-green-100 bg-white p-5 shadow-sm sm:p-6">
          <div className="flex flex-col justify-between gap-5 xl:flex-row xl:items-end">
            <div>
              ...
              <div className="mt-4 rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-xs font-black uppercase tracking-[0.12em] text-emerald-900">
                Curriculum CRUD for Pet Parent, Guru, and Ambassador academies. Hub: SitGuru University.
              </div>
            </div>
