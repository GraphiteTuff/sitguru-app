...
export default async function AdminVisitUpdatesPage({ params }: PageProps) {
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm font-semibold !text-slate-700 sm:text-base">
              Review the SitGuru PawReport™ timeline, photos, care notes, and
              completion details for this booking.
            </p>
          </div>
