...
import ExportsCenterClient from "./ExportsCenterClient";

export const dynamic = "force-dynamic";

export default async function AdminFinancialExportsPage() {
      ...
      <div className="min-h-screen bg-[#f7fbf8] px-6 py-10 text-slate-950">
        <div className="mx-auto max-w-3xl rounded-[2rem] border border-rose-100 bg-white p-8 shadow-sm">
          ...
          <p className="mt-3 text-sm font-semibold leading-6 text-slate-600">
            Sign in with a finance-enabled admin account to open the SitGuru
            Export Center.
          </p>
        </div>
      </div>
