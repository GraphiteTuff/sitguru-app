  ...
  return (
    <div className="mx-auto w-full max-w-[1480px] space-y-6 px-4 pb-10 pt-1 text-slate-900 sm:px-6 xl:px-8">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <Link href="/admin/financials/payouts" className="rounded-[1.4rem] border border-emerald-100 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"><WalletCards className="h-5 w-5 text-[#118a43]" /><p className="mt-3 text-base font-black text-[#163127]">Payout Command Center</p><p className="mt-1 text-sm text-slate-500">Review release queues, payout records, and operational payout activity.</p></Link>
