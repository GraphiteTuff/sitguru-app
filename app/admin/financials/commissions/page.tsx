    ...
    <div className="mx-auto w-full max-w-[1480px] space-y-6 px-4 pb-10 pt-1 text-slate-900 sm:px-6 xl:px-8">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
          ...
          <p className="mt-3 text-base font-black text-[#163127]">Stripe Transactions</p>
          <p className="mt-1 text-sm text-slate-500">
            Track customer payment capture, Stripe fees, refunds, disputes, and payout matching.
          </p>
        </Link>
