...
const quickHelpCards: HelpCard[] = [
  ...
  },
  {
    ...
    description:
      "Use role-specific SitGuru-only payment guides for Pet Parent checkout, Guru payout setup, Ambassador payout setup, credits, promo codes, tips, and receipts.",
...
const paymentGuides: PaymentGuide[] = [
  {
    ...
    audience: "For Gurus",
    description:
      "Complete Stripe payout setup so eligible SitGuru booking payouts, tips, commission, and referral earnings can be routed correctly. Gurus should not request or accept off-platform payments for SitGuru bookings.",
    ...
    highlights: [
      "Booking payouts",
      "Tips routed through SitGuru",
      "Commission and referral earnings",
    ],
  },
  {
    ...
    description:
      "Learn how Pet Parents securely request, review, and pay for pet care services through SitGuru checkout only, including cards, mobile wallets, Link by Stripe, saved methods, credits, promo codes, gift cards, and optional tips when available.",
    ...
    highlights: [
      "SitGuru checkout only",
      "Cards, wallets, Link, credits",
  ...
  },
  {
    ...
    description:
      "Complete Stripe payout setup so eligible ambassador payouts, commission, and referral earnings can be routed correctly through SitGuru. Ambassadors should direct users back to SitGuru checkout and referral links instead of outside payment arrangements.",
...
const sitGuruOnlyPaymentFlows = [
  {
    ...
    steps: [
      ...
      "Pay through SitGuru checkout only using the available secure options such as credit/debit card, Apple Pay, Google Pay, Link by Stripe, saved payment method, ACH/bank when available, PawPerks/PetPerks credits, referral credits, promo codes, gift cards, or SitGuru credit.",
      "Return to your Pet Parent dashboard for booking status, receipts, messages, PawReport Live, walk updates, final summaries, and reviews after completed care.",
    ],
  },
  {
    ...
    steps: [
      ...
      "Connect Stripe payout setup from the Guru dashboard or Stripe setup guide before eligible payouts can be sent.",
      "Keep all SitGuru booking payments inside SitGuru checkout. Do not ask Pet Parents to pay by cash, Venmo, Zelle, Cash App, PayPal, direct bank transfer, personal card reader, or other off-platform payment methods for SitGuru bookings.",
  ...
  },
  {
    ...
    steps: [
      ...
      "PawPerks/PetPerks credits, referral credits, promo codes, gift cards, SitGuru credits, and optional Guru tips should be entered or tracked through SitGuru only.",
      ...
      "Admin may review quote requests, payment options, checkout status, credits, promo codes, tips, payout status, and Stripe references to help resolve questions.",
    ],
  },
];
...
const helpSections: HelpSection[] = [
  ...
  },
  {
    title: "Payments & Payouts",
    description:
      "Help with SitGuru-only checkout, Stripe setup, booking totals, credits, promo codes, optional tips, payout tracking, and payment questions.",
    ...
    items: [
      ...
      },
      {
        question: "How do Pet Parents pay for services?",
        answer:
          "Pet Parents pay through SitGuru checkout only. Depending on what is available in checkout, they may use credit/debit card, Apple Pay, Google Pay, Link by Stripe, saved payment methods, ACH/bank when available, PawPerks/PetPerks credits, referral credits, promo codes, gift cards, SitGuru credits, and optional Guru tips. Receipts, booking status, PawReports, messages, and reviews stay connected to the SitGuru dashboard.",
      },
      {
      ...
      {
        question: "How do credits and promo codes work?",
        answer:
          "PawPerks or PetPerks credits, referral credits, promo codes, gift cards, and SitGuru credits should be entered or tracked through SitGuru only. If a credit or code does not appear correctly, contact support before paying.",
      },
      {
...
function SitGuruOnlyPaymentsSection() {
  return (
    <section
        ...
        <div className="grid gap-0 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
          <div className="bg-[linear-gradient(135deg,#ecfdf5_0%,#ffffff_48%,#eff6ff_100%)] p-6 sm:p-8 lg:p-10">
            <SectionEyebrow icon={<CreditCard className="h-4 w-4" />}>
              SitGuru-Only Payments
            </SectionEyebrow>

            <h2 className="mt-4 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">
              Set up, book, pay, tip, and receive payouts through SitGuru only.
            </h2>

            <p className="mt-4 text-base font-semibold leading-8 text-slate-700">
              SitGuru keeps booking records, receipts, PawReports, reviews, support context,
              credits, tips, and payout tracking connected by keeping service payments inside
              the SitGuru platform. Pet Parents should pay through SitGuru checkout. Gurus and
              Ambassadors should complete Stripe payout setup when eligible payouts apply.
            </p>

            <div className="mt-6 rounded-[1.4rem] border border-red-100 bg-red-50 p-5">
              <h3 className="text-xl font-black text-red-950">No off-platform payment rule</h3>
              <p className="mt-2 text-sm font-semibold leading-7 text-red-800">
                For SitGuru bookings, do not arrange payment by cash, Venmo, Zelle, Cash App,
                PayPal, personal card reader, direct bank transfer, check, or any other outside
                payment method. Keeping payment inside SitGuru helps protect records, support,
                PawReport history, reviews, credits, and payout tracking.
              </p>
            </div>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
                ...
                "ACH / bank when available",
                "PawPerks / PetPerks credits",
                "Referral, promo, gift card, and SitGuru credits",
                "Optional Guru tips through checkout",
                "Custom quote review when needed",
              ].map((item) => (
                <div
                  key={item}
                  className="rounded-2xl border border-emerald-100 bg-white px-4 py-3 text-sm font-black text-slate-800 shadow-sm"
                >
                  ✓ {item}
                </div>
              ))}
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            <div className="grid gap-4">
              {sitGuruOnlyPaymentFlows.map((flow) => (
                <div
                  key={flow.title}
                ...
                >
                  ...
                  <h3 className="mt-2 text-xl font-black text-slate-950">{flow.title}</h3>
                  <ol className="mt-4 grid gap-2 text-sm font-semibold leading-6 text-slate-700">
      ...
      <section className="relative border-b border-emerald-100 bg-[radial-gradient(circle_at_top,_rgba(16,185,129,0.16),_transparent_34%),linear-gradient(180deg,_#f7fffb_0%,_#effcf5_100%)]">
        <div className="mx-auto max-w-6xl px-4 py-14 text-center sm:px-6 sm:py-18 lg:px-8 lg:py-24">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 text-sm font-bold text-slate-600">
            ...
            <a href="#sitguru-only-payments" className="rounded-full border border-emerald-200 bg-white px-4 py-2 transition hover:bg-emerald-50">
              SitGuru-Only Payments
            </a>
            <span className="rounded-full border border-emerald-200 bg-white px-4 py-2">
              Ambassador Support
