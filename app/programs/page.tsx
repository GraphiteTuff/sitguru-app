...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Schools, workforce programs, military organizations, nonprofits, rescues, veterinary offices, and other community groups can connect people with the appropriate SitGuru pathway.",
  },
];
      ...
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <Link
            ...
            className="inline-flex min-h-12 flex-1 items-center justify-center gap-2 rounded-2xl bg-emerald-800 px-5 py-3 text-sm font-black text-white shadow-lg shadow-emerald-900/10 transition hover:bg-emerald-900"
          >
            Apply
            <ArrowRight size={17} />
          </Link>
    ...
    <main className="min-h-screen bg-[#f7faf7] text-slate-950">
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-700">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8 lg:py-20">
          <div>
            ...
            <h1
              className="mt-6 max-w-4xl text-4xl font-black leading-[1.02] tracking-[-0.045em] sm:text-5xl lg:text-6xl"
              style={{
                color: "#ffffff",
                WebkitTextFillColor: "#ffffff",
            ...
            >
              Find your path into the SitGuru community.
            </h1>
            ...
            >
              Provide pet care, represent SitGuru, or help people discover
      ...
      >
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-base font-semibold leading-7 text-slate-600">
            ...
            sends you to the right application.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-[32px] bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-700 p-6 sm:p-8">
            <Handshake size={30} className="text-emerald-200" />
            <p className="mt-5 text-xs font-black uppercase tracking-[0.18em] text-emerald-200">
              Program partners
            </p>
            <h2
            ...
            >
              Help people discover the right SitGuru opportunity.
            </h2>
            <p className="mt-4 text-sm font-semibold leading-7 text-emerald-50 sm:text-base">
              Schools, workforce organizations, military groups, nonprofits,
              rescues, veterinary offices, trainers, and other community
              partners can refer applicants to the appropriate path.
            </p>
            <Link
              href="/partners"
          ...
          <div className="rounded-[32px] border border-emerald-100 bg-white p-6 sm:p-8">
            ...
            <p className="mt-4 text-sm font-semibold leading-7 text-slate-600 sm:text-base">
              Use the standard Guru application when you do not need a
              specialized student, community, or military-connected pathway.
            </p>
            <Link
              href="/become-a-guru"
              className="mt-6 inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-emerald-800 px-5 py-3 text-sm font-black text-white transition hover:bg-emerald-900"
            >
              Become a Guru
              <ArrowRight size={17} />
            </Link>
      ...
      <section className="bg-[#f7faf7] px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-5xl rounded-[32px] border border-emerald-100 bg-white p-6 text-center shadow-[0_18px_50px_rgba(15,23,42,0.08)] sm:p-9">
          ...
          <Link
            href="#pet-care-pathways"
            className="mt-6 inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-emerald-800 px-6 py-3 text-sm font-black text-white transition hover:bg-emerald-900"
          >
            View programs
            <ArrowRight size={17} />
          </Link>
