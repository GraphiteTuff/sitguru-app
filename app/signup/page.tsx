...
import SocialIdentityButtons, {
  TraditionalEmailDivider,
} from "@/components/auth/SocialIdentityButtons";
...
function SignupPageContent() {
  ...
  async function startSocialSignup(provider: "google" | "apple") {
    try {
      resetAlerts();
      ...
      setError(
        caughtError instanceof Error
          ? caughtError.message
          : `${provider === "google" ? "Google" : "Apple"} signup could not start. Please try again.`,
      );
          ...
          <div className="grid flex-1 items-center gap-8 lg:grid-cols-[1fr_0.9fr]">
            ...
            <div className="mx-auto w-full max-w-xl rounded-[2rem] border border-[#eadfcd] bg-white p-5 shadow-2xl shadow-[#876b3d]/10 sm:p-7">
              <div className="mb-6">
                ...
                <p className="mt-2 text-sm leading-6 text-[#6a6256]">
                  Single-click social signup or traditional email — SitGuru will
                  guide you through any missing profile details from your
                  dashboard.
                </p>
              </div>
              ...
              <TraditionalEmailDivider label="Or use traditional email" />

              <div className="mb-5 mt-5 grid grid-cols-2 gap-2 rounded-2xl bg-[#f7f3ec] p-1">
                <button
                  type="button"
              ...
              <p className="mt-5 text-center text-xs leading-5 text-[#7b7164]">
                A verified email, phone, Google, or Apple identity is enough to
                create and use your account. Add another contact method whenever
                you are ready. Profile photo, services, pricing, availability,
                location, and payout setup are completed from your dashboard
                before becoming bookable.
              </p>
            </div>
          </div>
        </div>
