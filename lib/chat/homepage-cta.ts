...
- Internal follower counts / business metrics → only if the server registered fetchLiveSocialFollowers for this session; otherwise decline and offer [[cta:social]].
