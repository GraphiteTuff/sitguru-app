...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  /* —— Billing & Refunds —— */
  {
    ...
    summary:
      "Pet Parents, Gurus, and Ambassadors can pay for SitGuru services with Stripe, PayPal, Apple Pay, Google Pay, Venmo, and Plaid. Tips, promo codes, and refunds stay on the booking.",
    audience: "all",
  ...
  },
  {
    ...
    summary:
      "Pay in SitGuru checkout with Stripe, PayPal, Apple Pay, Google Pay, Venmo, or Plaid — then track receipts and PawReports in your dashboard.",
    audience: "parent",
    category: "Billing & Refunds",
    tags: ["payouts", "stripe", "tipping", "refunds", "pricing"],
    keywords: [
...
export const HELP_CATEGORIES = [
  ...
  },
  {
    ...
    description:
      "Pay in SitGuru checkout with Stripe, PayPal, Apple Pay, Google Pay, Venmo, or Plaid. Payouts, tips, credits, and refunds stay on SitGuru.",
    href: "/help/billing/payments-and-payouts",
